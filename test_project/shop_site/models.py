...
class Processor_element(models.Model):
    middle_processor_conaction = models.ForeignKey(Processor_category, related_name='middle_processor_conaction',
    ...
    processor_frequency = models.PositiveSmallIntegerField(default=0, verbose_name='Частота процессора', null=True,
                                                           blank=True)
    ...
    maximum_frequency_with_turbo_boost = models.PositiveSmallIntegerField(
        verbose_name='Максимальная частота с Turbo Boost', null=True, blank=True)
...
class Cooling_element(models.Model):
    middle_cooling_conaction = models.ForeignKey(Cooling_category, related_name='middle_cooling_conaction',
                                                 on_delete=models.CASCADE)
    ...
    number_of_heat_pipes = models.PositiveSmallIntegerField(default=0, verbose_name='Количество тепловых трубок',
    ...
    noise_level = models.DecimalField(max_digits=500, decimal_places=2, verbose_name='Уровень шума', null=True,
                                      blank=True)
...
class The_motherboard_element(models.Model):
    middle_the_motherboard_conaction = models.ForeignKey(The_motherboard_category,
                                                         related_name='middle_the_motherboard_conaction',
                                                         on_delete=models.CASCADE)
    ...
    number_of_lots = models.PositiveSmallIntegerField(default=0, verbose_name='Количество слотов памяти', null=True,
                                                      blank=True)
...
class Random_access_memory_element(models.Model):
    middle_memory_conaction = models.ForeignKey(Random_access_memory_category, related_name='middle_memory_conaction',
                                                on_delete=models.CASCADE)
...
class Video_card_element(models.Model):
    middle_video_card_conaction = models.ForeignKey(Video_card_category, related_name='middle_video_card_conaction',
                                                    on_delete=models.CASCADE)
    ...
    recommended_power_supply_power_supply = models.CharField(max_length=100,
                                                             verbose_name='Рекомендуемая мощность блока питания',
                                                             null=True, blank=True)
    technical_process = models.CharField(max_length=100, verbose_name='Техпроцесс', null=True, blank=True)
    the_amount_of_video_memory = models.CharField(max_length=100, verbose_name='Объем видеопамяти', null=True,
                                                  blank=True)
    video_memory_bus_bit_rate = models.CharField(max_length=100, verbose_name='Разрядность шины видеопамяти', null=True,
                                                 blank=True)
...
class The_headset_element(models.Model):
    middle_the_headset_conaction = models.ForeignKey(Headset_category, related_name='middle_headset_conaction',
                                                     on_delete=models.CASCADE)
    ...
    type_of_acoustic_design = models.CharField(max_length=100, verbose_name='Тип акустического оформления', null=True,
                                               blank=True)
    ...
    interface_connection_connector = models.CharField(max_length=100, verbose_name='Интерфейс/разъём подключения',
                                                      null=True, blank=True)
    type_of_batteries = models.CharField(max_length=100, verbose_name='Тип элементов питания', null=True, blank=True)
    battery_life = models.CharField(max_length=100, verbose_name='Продолжительность работы от аккумуляторов', null=True,
                                    blank=True)
    type_of_wireless_connection = models.CharField(max_length=100, verbose_name='Тип беспроводной связи', null=True,
                                                   blank=True)
    ...
    case_case_included = models.BooleanField(default=False, verbose_name='Чехол/футляр в комплекте', null=True,
                                             blank=True)
...
class Body_element(models.Model):  #Корпус элемент serialzers жазылды
    ...
    middle_body_conaction = models.ForeignKey(Body_category, on_delete=models.CASCADE,
                                              related_name='middle_body_conaction')
    type_size = models.CharField(max_length=25, verbose_name='Типопазмер', null=True, blank=True)
    length_video_card = models.PositiveSmallIntegerField(default=0, verbose_name='Максимальная длинна видеокарты',
                                                         null=True, blank=True)
    ...
    liquid_cooling = models.BooleanField(default=False,
                                         verbose_name='возможность устоновить систему жидкостного охлождения',
                                         null=True, blank=True)
    processor_cooler = models.CharField(max_length=100, verbose_name='Максимальная высота процессорного кулера',
                                        null=True, blank=True)
...
class Power_unit_element(models.Model):  #Блок питания serializers жазылды
    ...
    middle_power_unit_conaction = models.ForeignKey(Power_unit_category, on_delete=models.CASCADE,
                                                    related_name='middle_power_unit_conaction', null=True, blank=True)
...
class Wi_Fi_element(models.Model):  # wi fi serializers жазылды
    ...
    wi_fi_middle_conaction = models.ForeignKey(Wi_Fi_category, related_name='wi_fi_middle_conaction',
                                               on_delete=models.CASCADE)
    wi_fi_type = models.CharField(max_length=25, verbose_name='тип', null=True, blank=True)
    wi_fi_wireless_communication = models.CharField(max_length=25, verbose_name='Стандарт беспроводной связи',
                                                    null=True, blank=True)
    wi_fi_number_antennas = models.IntegerField(choices=[(i, str(i)) for i in range(5)],
                                                verbose_name='Стандарт беспроводной связи', null=True, blank=True)
    information_protection = models.CharField(max_length=25, verbose_name='Защита информации', null=True, blank=True)
    max_speed = models.CharField(max_length=25, verbose_name='Макс. скорость беспроводного соединения', null=True,
                                 blank=True)
...
class Sound_card_element(models.Model):  # Звуковая карта serializers жазылды
    ...
    sound_middle_conaction = models.ForeignKey(Sound_card_category, related_name='sound_middle_conaction',
    ...
    multi_audio = models.BooleanField(default=True, verbose_name='Возможность вывода многоканального звука', null=True,
                                      blank=True)
    input_connectors = models.SmallIntegerField(default=1, verbose_name='Входных разъемов jack 3.5 мм', null=True,
                                                blank=True)
...
class Headset_element(models.Model):
    middle_the_headset_conaction = models.ForeignKey(Headset_category, related_name='middle_the_headset_conaction',
                                                     on_delete=models.CASCADE)
    the_headset_element_name = models.CharField(max_length=100)
    manufacturer = models.CharField(max_length=100, verbose_name='Производитель', null=True, blank=True)
    type = models.CharField(max_length=100, verbose_name='Тип', null=True, blank=True)
...
class Operating_system_element(models.Model):  #Операционная система serializer  жазылды
    ...
    middle_operation_conaction = models.ForeignKey(Operating_system_category, related_name='middle_operation_conaction',
                                                   on_delete=models.CASCADE)
...
class Mouse_element(models.Model):  # Мышь serializer жазылды
    ...
    middle_mouse_conaction = models.ForeignKey(Mouse_catergory, on_delete=models.CASCADE,
                                               related_name='middle_mouse_conaction')
    ...
    sensor_opt_resolution = models.IntegerField(default=0, verbose_name='Разрешение оптического сенсора', null=True,
                                                blank=True)
...
class Keyboard_element(models.Model):
    ...
    middle_keyboard_conaction = models.ForeignKey(Keyboard_category, on_delete=models.CASCADE,
                                                  related_name='middle_keyboard_conaction', verbose_name='категория')
    keyboard_price = models.IntegerField(default=0)
    keyboard_img = models.ImageField(upload_to='keyboard_img', null=True, blank=True)
    connection_interface_keyboard = models.CharField(max_length=25, verbose_name='Интерфейс подключения', null=True,
                                                     blank=True)
...
class Manitor_element(models.Model):
    ...
    maximum_colors = models.CharField(max_length=25, verbose_name='Максимальное количество цветов', null=True,
                                      blank=True)
    ...
    middle_manitor_conaction = models.ForeignKey(Manitor_category, on_delete=models.CASCADE,
                                                 related_name='middle_manitor_conaction')
...
class CompChoices(models.Model):
    procecor = models.ForeignKey(Processor_element, on_delete=models.CASCADE, verbose_name='процессор', null=True,
                                 blank=True)
    cooling = models.ForeignKey(Cooling_category, on_delete=models.CASCADE, verbose_name='охлождения', null=True,
                                blank=True)
    memory = models.ForeignKey(Random_access_memory_category, on_delete=models.CASCADE,
                               verbose_name='оперативнная памят', null=True, blank=True)
    motherboard = models.ForeignKey(The_motherboard_category, on_delete=models.CASCADE,
                                    verbose_name='Материнская плата', null=True, blank=True)
    video_card = models.ForeignKey(Video_card_category, on_delete=models.CASCADE, verbose_name='видео карта', null=True,
                                   blank=True)
    hard_drive = models.ForeignKey(Hard_drive_category, on_delete=models.CASCADE, verbose_name='жесткий диск',
                                   null=True, blank=True)
    ssd_drive_1 = models.ForeignKey(SSD_drive_1_category, on_delete=models.CASCADE, verbose_name='SSD диск 1',
                                    null=True, blank=True)
    ...
    sound_card = models.ForeignKey(Sound_card_category, on_delete=models.CASCADE, verbose_name='звуковая карта',
                                   null=True, blank=True)
    operating_system = models.ForeignKey(Operating_system_category, on_delete=models.CASCADE,
                                         verbose_name='Операционнвя система', null=True, blank=True)
    mouse = models.ForeignKey(Mouse_catergory, on_delete=models.CASCADE, verbose_name='мышь', null=True, blank=True)
    keyboard = models.ForeignKey(Keyboard_category, on_delete=models.CASCADE, verbose_name='клавиатура', null=True,
                                 blank=True)
    manitor = models.ForeignKey(Manitor_category, on_delete=models.CASCADE, verbose_name='манитор', null=True,
                                blank=True)
    headset = models.ForeignKey(Headset_category, on_delete=models.CASCADE, verbose_name='гарнитура', null=True,
                                blank=True)
...
class Showcomp(models.Model):
    ...
    memory = models.ManyToManyField(Random_access_memory_category, verbose_name='оперативнная памят', null=True,
                                    blank=True)
    motherboard = models.ManyToManyField(The_motherboard_category, verbose_name='Материнская плата', null=True,
                                         blank=True)
    ...
    operating_system = models.ManyToManyField(Operating_system_category, verbose_name='Операционнвя система', null=True,
                                              blank=True)
...
class Cart(models.Model):
    ...
    def get_total_price(self):
        return sum(float(item.get_total_price()) for item in self.items.all())
...
class CartItem(models.Model):
    ...
    def get_total_price(self):
        return f'{self.main.procecor.price * self.quantity}'
