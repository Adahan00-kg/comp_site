    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body_img', models.ImageField(blank=True, null=True, upload_to='body_img')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headset_img', models.ImageField(blank=True, null=True, upload_to='headset_img/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('body_category', models.ManyToManyField(to='shop_site.body_category', verbose_name='корпус')),
                ('cooling', models.ManyToManyField(to='shop_site.cooling_category', verbose_name='охлождения')),
                ('dvd_drive', models.ManyToManyField(to='shop_site.dvd_drive_category', verbose_name='DVD привод')),
                ('hard_drive', models.ManyToManyField(to='shop_site.hard_drive_category', verbose_name='жесткий диск')),
                ('headset', models.ManyToManyField(to='shop_site.headset_category', verbose_name='гарнитура')),
                ('keyboard', models.ManyToManyField(to='shop_site.keyboard_category', verbose_name='клавиатура')),
                ('manitor', models.ManyToManyField(to='shop_site.manitor_category', verbose_name='манитор')),
                ('memory', models.ManyToManyField(to='shop_site.random_access_memory_category', verbose_name='оперативнная памят')),
                ('mouse', models.ManyToManyField(to='shop_site.mouse_catergory', verbose_name='мышь')),
                ('operating_system', models.ManyToManyField(to='shop_site.operating_system_category', verbose_name='Операционнвя система')),
                ('power_unit', models.ManyToManyField(to='shop_site.power_unit_category', verbose_name='блок питания')),
                ('procecor', models.ManyToManyField(to='shop_site.processor_category', verbose_name='процессор')),
                ('sound_card', models.ManyToManyField(to='shop_site.sound_card_category', verbose_name='звуковая карта')),
                ('ssd_drive_1', models.ManyToManyField(to='shop_site.ssd_drive_1_category', verbose_name='SSD диск 1')),
                ('ssd_drive_2', models.ManyToManyField(to='shop_site.ssd_drive_2_category', verbose_name='SSD диск 2')),
                ('motherboard', models.ManyToManyField(to='shop_site.the_motherboard_category', verbose_name='Материнская плата')),
                ('video_card', models.ManyToManyField(to='shop_site.video_card_category', verbose_name='видео карта')),
                ('wi_fi', models.ManyToManyField(to='shop_site.wi_fi_category', verbose_name='wi-fi')),
            ],
        ),
        migrations.CreateModel(
            name='CompChoices',
